...
public class BurgerComposition1 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BurgerComposition1 window = new BurgerComposition1();
	...
	public BurgerComposition1() {
		...
		JLabel lblNewLabel_1 = new JLabel("치즈와퍼+프렌치프라이(L)+콜라(L)");
		...
		JLabel lblNewLabel_1_1_1 = new JLabel("치즈와퍼 단품");
		...
		JLabel lblNewLabel_1_1 = new JLabel("치즈와퍼+프렌치프라이(R)+콜라(R)");
