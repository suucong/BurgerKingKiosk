...
public class BurgerComposition8 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BurgerComposition8 window = new BurgerComposition8();
	...
	public BurgerComposition8() {
		...
		JLabel lblNewLabel_1 = new JLabel("베이컨치즈와퍼+프렌치프라이(L)+콜라(L)");
		...
		JLabel lblNewLabel_1_1_1 = new JLabel("베이컨치즈와퍼 단품");
		...
		JLabel lblNewLabel_1_1 = new JLabel("베이컨치즈와퍼+프렌치프라이(R)+콜라(R)");
