...
public class BurgerComposition2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BurgerComposition2 window = new BurgerComposition2();
	...
	public BurgerComposition2() {
		...
		JLabel lblNewLabel_1 = new JLabel("와퍼+프렌치프라이(L)+콜라(L)");
		...
		JLabel lblNewLabel_1_1_1 = new JLabel("와퍼 단품");
		...
		JLabel lblNewLabel_1_1 = new JLabel("와퍼+프렌치프라이(R)+콜라(R)");
