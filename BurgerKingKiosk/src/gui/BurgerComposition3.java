...
public class BurgerComposition3 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BurgerComposition3 window = new BurgerComposition3();
	...
	public BurgerComposition3() {
		...
		JLabel lblNewLabel_1 = new JLabel("불고기와퍼+프렌치프라이(L)+콜라(L)");
		...
		JLabel lblNewLabel_1_1_1 = new JLabel("불고기와퍼 단품");
		...
		JLabel lblNewLabel_1_1 = new JLabel("불고기와퍼+프렌치프라이(R)+콜라(R)");
