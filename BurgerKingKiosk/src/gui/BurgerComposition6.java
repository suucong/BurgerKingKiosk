...
public class BurgerComposition6 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BurgerComposition6 window = new BurgerComposition6();
	...
	public BurgerComposition6() {
		...
		JLabel lblNewLabel_1 = new JLabel("스태커3와퍼+프렌치프라이(L)+콜라(L)");
		...
		JLabel lblNewLabel_1_1_1 = new JLabel("스태커3와퍼 단품");
		...
		JLabel lblNewLabel_1_1 = new JLabel("스태커3와퍼+프렌치프라이(R)+콜라(R)");
